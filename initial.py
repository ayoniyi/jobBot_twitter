...
class TwitterJobBot:
    def __init__(self):
        ...
        self.min_followers = 1001
        self.min_account_age_days = 366
        self.excluded_words = [
            "not hiring",
            "closed",
            "filled",
    ...
    @sleep_and_retry
    @limits(calls=180, period=900)  # 180 calls per 35 minutes (Twitter API limit)
...
"{job_post.tweet_text[:200]}{'...' if len(job_post.tweet_text) > 200 else ''}"
    ...
    def start_monitoring(self):
        ...
        # Schedule searches every 35 minutes
        schedule.every(35).minutes.do(self.run_search_cycle)
